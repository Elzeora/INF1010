...
void Boisson::setTaxe() { taxe_ = 0.12; }
double Boisson::getTaxe() const { return taxe_; }
string_view Boisson::getNom() const { return nom_; }
double Boisson::getPrix()  const { return prix_; }
