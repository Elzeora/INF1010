...
public:
	...
	Menu& operator+=(owner<Plat*> plat);  // TODO fait //? Le parametre est indique "owner" pour montrer que cette methode prend possession du pointeur qui lui est passe, mais owner<Plat*> est equivalent à Plat*; voir pointers.h .
